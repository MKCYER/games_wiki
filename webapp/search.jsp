...
<html>
<head>
    <title><%=request.getParameter("con")%></title>
    <!-- For-Mobile-Apps -->
...
<div>
    ...
    <div class="test test-5 showgame">
        <div class="scrollbar" >
    ...
    <div class="article">
        <%
            ...
            String sql="select * from passages as p,users as u where p.uid=u.uid and p.title like \'%"+con+"%\';";
