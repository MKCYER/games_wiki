                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <%
                            ...
                            try {
                                ...
                                String sql = "select count(*) as total from passages;";  //查询语句
                                ...
                                set=sta.executeQuery("select * from passages as p,users as u,games as g where p.uid=u.uid and p.gameId=g.gameId");
                    ...
                    <div class="list-page">
                        <form>
                            ...
                            <%
                                if(nowpage==1)
                                    out.print("首页 上一页 <a href=\"passageControl.jsp?nowpage="+(nowpage+1)+"\">下一页</a> <a href=\"passageControl.jsp?nowpage="+totalpage+"\">尾页</a>");
                                else if(nowpage==totalpage)
                                    out.print("<a href=\"passageControl.jsp\">首页</a>  <a href=\"passageControl.jsp?nowpage="+(nowpage-1)+"\">上一页</a> 下一页 尾页");
                                else
                                    out.print("<a href=\"passageControl.jsp\">首页</a>  <a href=\"passageControl.jsp?nowpage="+(nowpage-1)+"\">上一页</a> <a href=\"passageControl.jsp?nowpage="+(nowpage+1)+"\">下一页</a> <a href=\"passageControl.jsp?nowpage="+totalpage+"\">尾页</a>");
                            %>
                        </form>
                    </div>
                </div>
